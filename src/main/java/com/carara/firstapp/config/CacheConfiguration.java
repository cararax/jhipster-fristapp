package com.carara.firstapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.carara.firstapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.carara.firstapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.carara.firstapp.domain.User.class.getName());
