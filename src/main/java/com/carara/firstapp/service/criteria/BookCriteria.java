package com.carara.firstapp.service.criteria;
...
/**
 * Criteria class for the {@link com.carara.firstapp.domain.Book} entity. This class is used
 * in {@link com.carara.firstapp.web.rest.BookResource} to receive all the possible filtering options from
...
public class BookCriteria implements Serializable, Criteria {
    ...
    public BookCriteria(BookCriteria other) {
        ...
        this.author_bookId = other.author_bookId == null ? null : other.author_bookId.copy();
    ...
    public LongFilter author_bookId() {
        if (author_bookId == null) {
            author_bookId = new LongFilter();
        }
        return author_bookId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(author_bookId, that.author_bookId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, publicationDate, price, author_bookId, distinct);
    }
